...
public class ProdutoController {
    ...
    public String salvar(@Valid @ModelAttribute("produto") ProdutoModel produto,
        ...
        try {
            String usuarioAtualizacao = principal != null ? principal.getName() : "Sistema";
            service.salvar(produto, usuarioAtualizacao);
    ...
    public String historico(Model model) {
        model.addAttribute("auditorias", service.listarHistoricoAtualizacoes());
    ...
    public String excluir(@PathVariable long id, Principal principal) {
        String usuarioLogado = principal != null ? principal.getName() : "Sistema";
